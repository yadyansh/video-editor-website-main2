        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6">
          {features.map((feature, index) => (
            <motion.div
              ...
              className="group p-5 sm:p-6 bg-cinematic-dark rounded-2xl border border-cinematic-light hover:border-accent-blue/50 transition-all duration-300 hover:shadow-lg hover:shadow-accent-blue/10"
            >
              <div className={`w-12 h-12 mb-3 sm:mb-4 rounded-xl bg-gradient-to-br ${feature.gradient} p-3 flex items-center justify-center group-hover:scale-110 transition-transform duration-300`}>
