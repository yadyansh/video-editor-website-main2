    ...
    <section id="canvas-projects" className="py-20 bg-cinematic-black">
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="flex flex-col lg:flex-row items-center justify-center w-full gap-4">
          <Card title="Saksham - YouTube Video" icon={<Film className="h-10 w-10" />}>
            <CanvasRevealEffect
              animationSpeed={3}
              containerClassName="bg-emerald-900"
            />
          </Card>
          <Card title="Swift Desk - Commercial" icon={<Video className="h-10 w-10" />}>
            <CanvasRevealEffect
              animationSpeed={3}
          ...
          <Card title="Task 12 - Short Film" icon={<Scissors className="h-10 w-10" />}>
            <CanvasRevealEffect
              animationSpeed={3}
